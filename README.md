...
4. This project is about manipulating and traversing the DOM with jQuery
5. Fork the project repo from [Github](https://github.com/udacity/frontend-nanodegree-resume) and begin building you resume.
6. If you are prompted to do so, you may want to get a [Google Maps API key] and include it as the value of the `key` parameter when loading the Google Maps API in **index.html**:
